package org.example.cambioservice.model;
...
public class Cambio implements Serializable {
  ...
  @Transient // O @Transcient é utilizado para informar ao JPA que o atributo não deve ser persistido no banco de dados.
